...
const hasuraPluginSpecification: PluginSpecification = {
  ...
  functionConfigurationComponents: {
    "execute-sql-files": RunSqlActionConfigurationComponent,
  ...
  pluginTranslations: {
    nl: {
      ...
      "execute-sql-files": "SQL-bestanden uitvoeren",
      files: "SQL-bestanden (HASURA_DDL_DIR)",
    ...
    en: {
      ...
      files: "SQL files (HASURA_DDL_DIR)",
